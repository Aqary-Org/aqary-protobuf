...
const (
	...
	PropertyAndUnitService_PublishPropertyAndUnit_FullMethodName  = "/property_nd_unit.PropertyAndUnitService/PublishPropertyAndUnit"
)
...
type PropertyAndUnitServiceClient interface {
	...
	PublishPropertyAndUnit(ctx context.Context, in *PublishPropertyAndUnitRequest, opts ...grpc.CallOption) (*CreatePropertyAndUnitResponse, error)
}
...
func (c *propertyAndUnitServiceClient) UpdatePropertyUnit(ctx context.Context, in *CreatePropertyAndUnitRequest, opts ...grpc.CallOption) (*CreatePropertyAndUnitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreatePropertyAndUnitResponse)
	err := c.cc.Invoke(ctx, PropertyAndUnitService_UpdatePropertyUnit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propertyAndUnitServiceClient) CreatePropertyAndUnitV2(ctx context.Context, in *CreatePropertyAndUnitRequestV2, opts ...grpc.CallOption) (*CreatePropertyAndUnitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreatePropertyAndUnitResponse)
	err := c.cc.Invoke(ctx, PropertyAndUnitService_CreatePropertyAndUnitV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propertyAndUnitServiceClient) PublishPropertyAndUnit(ctx context.Context, in *PublishPropertyAndUnitRequest, opts ...grpc.CallOption) (*CreatePropertyAndUnitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreatePropertyAndUnitResponse)
	err := c.cc.Invoke(ctx, PropertyAndUnitService_PublishPropertyAndUnit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PropertyAndUnitServiceServer interface {
	...
	PublishPropertyAndUnit(context.Context, *PublishPropertyAndUnitRequest) (*CreatePropertyAndUnitResponse, error)
...
func (UnimplementedPropertyAndUnitServiceServer) UpdatePropertyUnit(context.Context, *CreatePropertyAndUnitRequest) (*CreatePropertyAndUnitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdatePropertyUnit not implemented")
}
...
func (UnimplementedPropertyAndUnitServiceServer) PublishPropertyAndUnit(context.Context, *PublishPropertyAndUnitRequest) (*CreatePropertyAndUnitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishPropertyAndUnit not implemented")
}
...
func _PropertyAndUnitService_UpdatePropertyUnit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePropertyAndUnitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PropertyAndUnitServiceServer).UpdatePropertyUnit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PropertyAndUnitService_UpdatePropertyUnit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyAndUnitServiceServer).UpdatePropertyUnit(ctx, req.(*CreatePropertyAndUnitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PropertyAndUnitService_CreatePropertyAndUnitV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePropertyAndUnitRequestV2)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PropertyAndUnitServiceServer).CreatePropertyAndUnitV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PropertyAndUnitService_CreatePropertyAndUnitV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyAndUnitServiceServer).CreatePropertyAndUnitV2(ctx, req.(*CreatePropertyAndUnitRequestV2))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PropertyAndUnitService_PublishPropertyAndUnit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishPropertyAndUnitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PropertyAndUnitServiceServer).PublishPropertyAndUnit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PropertyAndUnitService_PublishPropertyAndUnit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PropertyAndUnitServiceServer).PublishPropertyAndUnit(ctx, req.(*PublishPropertyAndUnitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PropertyAndUnitService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdatePropertyUnit",
			Handler:    _PropertyAndUnitService_UpdatePropertyUnit_Handler,
		},
		{
		...
		{
			MethodName: "PublishPropertyAndUnit",
			Handler:    _PropertyAndUnitService_PublishPropertyAndUnit_Handler,
		},
	},
